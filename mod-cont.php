...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form3")) {
  $updateSQL = sprintf("UPDATE tb_contactos SET Nombre=%s, Apellido=%s, Apodo=%s , telefono=%s, celular=%s, idGrupo=%s WHERE idContacto=%s",
       ...
       <tr>
         ...
         <td width="60%"><span id="spryselect1">
           <select name="grupo" class="datos" id="grupo">
			 ...
			 do {  
?>
             <option value="<?php echo $row_grupos['idGrupo'] ?>" selected="selected" > <?php echo $row_grupos['nombreGrupo']?></option>
             <?php
