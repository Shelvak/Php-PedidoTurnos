...
$contacto = $diaNacio . "-" . "  " . $row_contacto1['Nombre'] . " " . $row_contacto1['Apellido'] . "  ($cump)";
...
?>
      ...
      <form id="form1" name="form1" method="post" action="">
       <table width="95%" align="center" border="1">
		...
		<tr> 
		<td> <?php sort($enero); for ($z=0; $z<=$a; $z++) echo $enero[$z] . "</br>"; ?></td>
		<td> <?php sort($febrero); for ($z=0; $z<=$b; $z++) echo $febrero[$z] . "</br>"; ?></td>
		<td> <?php sort($marzo); for ($z=0; $z<=$c; $z++) echo $marzo[$z] . "</br>"; ?></td>
		<td> <?php sort($abril); for ($z=0; $z<=$d; $z++) echo $abril[$z] . "</br>"; ?></td>
		</tr>
        </table>
        <p>&nbsp;</p>
        <table width="95%" align="center" border="1">
		...
		<tr> 
		<td> <?php sort($mayo); for ($z=0; $z<=$e; $z++) echo $mayo[$z] . "</br>"; ?></td>
		<td> <?php sort($junio); for ($z=0; $z<=$f; $z++) echo $junio[$z] . "</br>"; ?></td>
		<td> <?php sort($julio); for ($z=0; $z<=$g; $z++) echo $julio[$z] . "</br>"; ?></td>
		<td> <?php sort($agosto); for ($z=0; $z<=$h; $z++) echo $agosto[$z] . "</br>"; ?></td>
		</tr>
        </table>
        <p>&nbsp;</p>
        <table width="95%" align="center" border="1">
		...
		<tr> 
		<td> <?php sort($septiembre); for ($z=0; $z<=$i; $z++) echo $septiembre[$z] . "</br>"; ?></td>
		<td> <?php sort($octubre); for ($z=0; $z<=$j; $z++) echo $octubre[$z] . "</br>"; ?></td>
		<td> <?php sort($noviembre); for ($z=0; $z<=$k; $z++) echo $noviembre[$z] . "</br>"; ?></td>
		<td> <?php sort($diciembre); for ($z=0; $z<=$l; $z++) echo $diciembre[$z] . "</br>"; ?></td>
		</tr>
        </table>
       <p>&nbsp;</p>
