...
<table width="100%" border="2" cellspacing="0" cellpadding="0">
  ...
  if ($aux == 0) echo "Ninguno";
    ...
    <?php 
	include ('connections/coso1.php');
	$grup = $_POST['crea-grup'];
	$coneccion = mysql_connect($host , $usuario , $contra); 
	mysql_select_db("$db");
	$query_a = "INSERT into tb_grupos (nombreGrupo) VALUES ('$grup')";
	$resultado = mysql_query ($query_a) or die (mysql_error()) ;
		if (resultado){
		echo "Se cargo el grupo : </br>" ;
		echo $grup;}
		else
		echo "te re kbio";
